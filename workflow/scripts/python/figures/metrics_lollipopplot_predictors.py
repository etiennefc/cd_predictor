...
output_all = snakemake.output.lollipopplot_all
output_cd = snakemake.output.lollipopplot_expressed_cd
output_pseudo = snakemake.output.lollipopplot_pseudo
...
for i, subset in enumerate([output_all, output_cd, output_pseudo]):
    ...
    # Create graph
    ft.lollipop(final_df, color_dict, titles[i], subset)
