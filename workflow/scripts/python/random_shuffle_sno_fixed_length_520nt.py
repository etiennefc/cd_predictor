...
# Iterate over all expressed C/D and add shuffled extended sequence of fixed 520 nt length as column
ext_seq_dict, shuffled_ext_seq_dict = dict(zip(sno_df.gene_id, sno_df.extended_520nt_sequence)), {}
...
sno_df['shuffled_extended_520nt_seq'] = sno_df.gene_id.map(shuffled_ext_seq_dict)
